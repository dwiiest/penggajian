...
class OvertimeExport implements FromCollection, WithHeadings, WithStyles, WithColumnWidths, WithTitle, WithEvents
{
    ...
    public function collection()
    {
        ...
        foreach($this->reportData as $index => $item) {
            ...
            $data->push([
                ...
                (int) $item['total_overtime'],
                (float) $item['total_hours'],
                (float) $item['total_pay'],
            ]);
        }
    ...
    {
        return "Lembur {$this->monthName} {$this->year}";
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                // Format currency untuk kolom pembayaran
                ...
                $sheet->getStyle("F{$totalRow}:H{$totalRow}")->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
