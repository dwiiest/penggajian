...
<div class="row mb-4">
    <div class="col-12">
        <div class="d-flex align-items-center">
            ...
            <div>
                <h4 class="mb-1 fw-bold">Tambah Karyawan Baru</h4>
                <p class="text-muted mb-0">Isi form di bawah untuk menambah karyawan</p>
            </div>
        </div>
    </div>
</div>
                    ...
                    <select class="form-select @error('user_id') is-invalid @enderror" 
                        ...
                        @forelse($users as $user)
                            <option value="{{ $user->id }}" {{ old('user_id') == $user->id ? 'selected' : '' }}>
                                {{ $user->name }} - {{ $user->email }} ({{ ucfirst($user->role->name) }})
                            </option>
                        @empty
    ...
    <div class="col-lg-4">
        <div class="chart-card bg-light">
            ...
            <ul class="list-unstyled">
                <li class="mb-2">
                    ...
                    <small>Pilih user yang sudah terdaftar</small>
                </li>
                <li class="mb-2">
                    <i class="bi bi-check-circle text-success me-2"></i>
                    <small>NIK dan NIP harus unik</small>
                </li>
                <li class="mb-2">
                    <i class="bi bi-check-circle text-success me-2"></i>
                    <small>Jabatan menentukan gaji pokok</small>
                </li>
                <li class="mb-2">
                    <i class="bi bi-check-circle text-success me-2"></i>
                    <small>Departemen untuk pengelompokan</small>
                </li>
                <li class="mb-2">
                    <i class="bi bi-check-circle text-success me-2"></i>
                    <small>Info bank untuk transfer gaji</small>
                </li>
            </ul>
            ...
            <div class="alert alert-info mt-3">
                <small>
                    ...
                    User yang sudah jadi karyawan tidak bisa dipilih lagi
                </small>
            </div>
        </div>
        ...
        <div class="alert alert-warning mt-3">
            <small>
                ...
                Tidak ada user tersedia. Silakan tambah user terlebih dahulu di menu Admin.
            </small>
        </div>
        @endif
    </div>
